...
public class OpenRobertaConnector {
    ...
    public void run() {
        ...
        while ( !Thread.currentThread().isInterrupted() ) {
            ...
            while ( (selectedRobot == null) ) {
                ...
                // Connect to dinobot if only one was found
                if ( this.robotDetectorHelper.allDetectorsRanOnce() && (robots.size() == 1) ){
                    detectedRobot = (IRobot) robots.toArray()[0];
                    if(detectedRobot.getName() == "dinobot") {
                        selectedRobot =  (IRobot) robots.toArray()[0];
                    }
                }
                ...
                try {
                    ...
                    //insert no dinobot connected message
