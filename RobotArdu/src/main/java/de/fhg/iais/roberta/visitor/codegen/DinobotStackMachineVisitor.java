...
public class DinobotStackMachineVisitor<V> extends AbstractStackMachineVisitor<V> implements IDinobotVisitor<V> {

    public DinobotStackMachineVisitor(ConfigurationAst configuration, List<List<Phrase<Void>>> phrases,
            ILanguage language) {
        super(configuration);
    ...
    // JSONObject o = mk(C.SET_LANGUAGE_ACTION, setLanguageAction).put(C.LANGUAGE,
    // language);
    // return app(o);
    // }
    ...
    public V visitDriveAction(DriveAction<V> driveAction) {
        ...
        JSONObject o = mk(C.DRIVE_ACTION, driveAction).put(C.DRIVE_DIRECTION, driveDirection).put(C.NAME, "dinobot").put(C.SPEED_ONLY, speedOnly);
        if ( speedOnly ) {
            return app(o);
        } else {
            app(o);
            return app(mk(C.STOP_DRIVE, driveAction).put(C.NAME, "dinobot"));
        }
    }
    ...
    public V visitTurnAction(TurnAction<V> turnAction) {
        ...
        JSONObject o =
            mk(C.TURN_ACTION, turnAction).put(C.TURN_DIRECTION, turnDirection.toString().toLowerCase()).put(C.NAME, "dinobot").put(C.SPEED_ONLY, speedOnly);
        if ( speedOnly ) {
            return app(o);
        } else {
            app(o);
            return app(mk(C.STOP_DRIVE, turnAction).put(C.NAME, "dinobot"));
        }
    }
    ...
    public V visitCurveAction(CurveAction<V> curveAction) {
        ...
        JSONObject o = mk(C.CURVE_ACTION, curveAction).put(C.DRIVE_DIRECTION, driveDirection).put(C.NAME, "dinobot").put(C.SPEED_ONLY, speedOnly);
        if ( speedOnly ) {
            return app(o);
        } else {
            app(o);
            return app(mk(C.STOP_DRIVE, curveAction).put(C.NAME, "dinobot"));
        }
    }
    ...
    //     //     driveDirection = getDriveDirection(driveAction.getDirection() == DriveDirection.FOREWARD);
    //     // }
    //     JSONObject o = mk(C.DRIVE_ACTION, driveAction).put(C.DRIVE_DIRECTION, driveDirection).put(C.NAME, "dinobot")
    ...
    //     //     turnDirection = getTurnDirection(turnAction.getDirection() == TurnDirection.LEFT);
    //     // }
    //     JSONObject o = mk(C.TURN_ACTION, turnAction).put(C.TURN_DIRECTION, turnDirection.toString().toLowerCase())
    //             .put(C.NAME, "dinobot").put(C.SPEED_ONLY, speedOnly);
    //     if (speedOnly) {
    //         return app(o);
    //     } else {
    //         app(o);
    ...
    //     //     driveDirection = getDriveDirection(curveAction.getDirection() == DriveDirection.FOREWARD);
    //     // }
    //     JSONObject o = mk(C.CURVE_ACTION, curveAction).put(C.DRIVE_DIRECTION, driveDirection).put(C.NAME, "dinobot")
    //             .put(C.SPEED_ONLY, speedOnly);
    //     if (speedOnly) {
    //         return app(o);
    //     } else {
    ...
    public V visitMotorDriveStopAction(MotorDriveStopAction<V> stopAction) {
        JSONObject o = mk(C.STOP_DRIVE, stopAction).put(C.NAME, "dinobot");
        return app(o);
    }
    ...
    public V visitMotorOnAction(MotorOnAction<V> motorOnAction) {
        ...
        JSONObject o = mk(C.MOTOR_ON_ACTION, motorOnAction).put(C.PORT, port.toLowerCase())
                .put(C.NAME, port.toLowerCase()).put(C.SPEED_ONLY, speedOnly);
        if (speedOnly) {
            return app(o);
        } else {
    ...
    //     JSONObject o = mk(C.GET_SAMPLE, colorSensor).put(C.GET_SAMPLE, C.COLOR).put(C.PORT, port)
    //             .put(C.MODE, mode.toLowerCase()).put(C.NAME, "ev3");
    //     return app(o);
    // }
    ...
    //     } else {
    //         o = mk(C.GET_SAMPLE, encoderSensor).put(C.GET_SAMPLE, C.ENCODER_SENSOR_SAMPLE).put(C.PORT, port)
    //                 .put(C.MODE, mode).put(C.NAME, "ev3");
    //     }
    //     return app(o);
    // }
    ...
    //     JSONObject o = mk(C.GET_SAMPLE, temperatureSensor).put(C.GET_SAMPLE, C.TEMPERATURE)
    //             .put(C.PORT, mode.toLowerCase()).put(C.NAME, "ev3");
    //     return app(o);
    // }
    ...
    //     // TODO check if this is really supported!
    //     JSONObject o = mk(C.GET_SAMPLE, lightSensor).put(C.GET_SAMPLE, C.LIGHT).put(C.PORT, C.AMBIENTLIGHT).put(C.NAME,
    //             "ev3");
    //     return app(o);
    // }
    ...
    //     JSONObject o = mk(C.GET_SAMPLE, sensorGetSample).put(C.GET_SAMPLE, C.PIN + port).put(C.MODE, mode.toLowerCase())
    //             .put(C.NAME, "ev3");
    //     return app(o);
    // }
    ...
    //     // TODO check if this is really supported!
    //     JSONObject o = mk(C.GET_SAMPLE, soundSensor).put(C.GET_SAMPLE, C.SOUND).put(C.MODE, C.VOLUME).put(C.NAME,
    //             "ev3");
    //     return app(o);
    // }
    ...
    //     JSONObject o = mk(C.GET_SAMPLE, compassSensor).put(C.GET_SAMPLE, C.COMPASS).put(C.MODE, mode.toLowerCase())
    //             .put(C.NAME, "ev3");
    //     return app(o);
    // }
    ...
    //     } else {
    //         o = mk(C.GET_SAMPLE, gyroSensor).put(C.GET_SAMPLE, C.GYRO).put(C.MODE, mode).put(C.PORT, port).put(C.NAME,
    //                 "ev3");
    //     }
    //     return app(o);
    // }
    ...
    //     JSONObject o = mk(C.GET_SAMPLE, ultrasonicSensor).put(C.GET_SAMPLE, C.ULTRASONIC).put(C.PORT, port)
    //             .put(C.MODE, mode.toLowerCase()).put(C.NAME, "ev3");
    //     return app(o);
    // }
