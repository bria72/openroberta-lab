define(['simulation.simulation', 'interpreter.constants', 'simulation.robot', 'guiState.controller'], function(SIM, C, Robot, GUISTATE_C) {
    ...
    /**
     * Creates a new Dinobot for a simulation.
     * 
     * This Dinobot is a differential drive Dinobot. It has two wheels directly
     * connected to motors and several sensors. Each component of the Dinobot has a
     * position in the Dinobots coordinate system. The Dinobot itself has a pose in the
     * global coordinate system (x, y, theta).
     * 
     * @class
     */
    function Dinobot(pose, configuration, num, robotBehaviour) {
    ...
    Dinobot.prototype = Object.create(Robot.prototype);
    Dinobot.prototype.constructor = Dinobot;

    Dinobot.prototype.reset = function() {
        this.encoder.left = 0;
    ...
    /**
     * Update all actions of the Dinobot. The new pose is calculated with the
     * forward kinematics equations for a differential drive Dinobot.
     * 
     * @param {actions}
     ...
     * 
     */
    Dinobot.prototype.update = function() {
        // update pose
     ...
     * 
     * @param {Number}
     *            sin the sine from the orientation from the Dinobot
     * @param {Number}
     *            cos the cosine from the orientation from the Dinobot
     * @param {point}
     *            point to translate
     * @returns the translated point
     * 
     */
    Dinobot.prototype.translate = function(sin, cos, point) {
